<script setup>
import Test from '@/Components/MyComponent/Test.vue';
...
<template>
    ...
    <admin-layout>
        <div class="rounded-xl bg-white p-10 shadow-md">
            <h1 class="px-4">Dashboard overview</h1>
            <div class="m-4 grid gap-5 sm:grid-cols-3 w-full">
            ...
            <div class="m-4 grid gap-5 sm:grid-cols-3 w-full">
                ...
                <div class="px-4 py-6 shadow-lg shadow-blue-100">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-14 w-14 rounded-xl bg-green-400 p-4 text-white"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
