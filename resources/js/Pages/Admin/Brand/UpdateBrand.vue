...
const brand = computed(() => props.brandd)
const errors = computed(() => usePage().props.errors ?? '');

const form = reactive({
    name: brand.value.brand_name,
    status: Boolean(brand.value.published),
    banner: Boolean(brand.value.is_banner),
    brandLogo: '',
    brandSlider: '',
...
const submit = () => {
    ...
    router.post(route('brand.update', { id: brand.value.id }),
        {
            _method: 'patch',
                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="col-span-full flex md:flex-row sm:flex-col gap-3">
                                ...
                                <div class="w-1/3 flex sm:w-full  items-center">
                                    ...
                                    <div class="">
                                        ...
                                        <ErrorMessage :error-message="errors ? errors.banner : ''" />
                            ...
                            <div class="col-span-full flex md:flex-row sm:flex-col gap-8 items-center">
                                <div>
                                    <img class=" max-w-20 h-auto" :src="`/storage/${brand.brand_logo}`" alt="">
                                </div>
                            ...
                            <div class="col-span-full flex md:flex-row sm:flex-col gap-8">
                                <img class="w-full max-h-40 object-cover object-center"
                                    :src="`/storage/${brand.brand_slider}`" alt="">
                            </div>
