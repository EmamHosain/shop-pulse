                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('page.dashboardOverview')">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('page.dashboardOverview')"
                                    :active="route().current('page.dashboardOverview')">
                                    Dashboard
                                </NavLink>
                            </div>
                        </div>
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink :href="route('page.dashboardOverview')">
                                            Dashboard
                                        </DropdownLink>
